...
public interface EmailVerificationService {
     ...
     * @throws backend.pineapple_ecommerce.exception.BusinessException nếu OTP sai/hết hạn
     */
     ...
     * Nếu vượt quá → ném {@link backend.pineapple_ecommerce.exception.BusinessException}.
     *
     * @param email email cần gửi lại OTP
     * @throws backend.pineapple_ecommerce.exception.BusinessException nếu vượt rate limit
